const APIKEY = "42106ea1aaf244899376c2fedd6fda34";// 填入你申请的KEY
Page({
   ...
   */
  data: {
    showHourly: false,  // 控制24小时预报的显示
    showDaily: false,   // 控制7天预报的显示
    bannerImages: [
  ...
  toggleHourly() {
    this.setData({
      showHourly: !this.data.showHourly
    })
  },
